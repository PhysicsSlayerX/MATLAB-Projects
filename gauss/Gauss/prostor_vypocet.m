function prostor_vypocet;
global jazyk R1 W1 q1 scrsz a1 b1 k;

handle=findobj('Tag','delka');
d=str2num(get(handle,'String'));
...
load prostor_vypocet
texty=[{'Volnı prostor','Parametry svazku pred optickım prvkem','Polomìr svazku W1 je','Polomìr vlnoplochy R1 je','Parametry svazku za optickım prvkem','Znovu','Konec'};
{'Empty space','Parameters in front of optical element','Radius of beam W1 is','Radius of waveplane R1 is','Parameters behind optical element','Again','End'}];
