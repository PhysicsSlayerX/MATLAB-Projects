...
load rov_zrcadlo_vypocet
texty=[{'Rovinné zrcadlo','Parametry svazku pred optickım prvkem','Polomìr svazku W1 je','Polomìr vlnoplochy R1 je','Parametry svazku za optickım prvkem','Znovu','Konec'};
{'Plane mirror','Parameters in front of optical element','Radius of beam W1 is','Radius of waveplane R1 is','Parameters behind optical element','Again','End'}];
