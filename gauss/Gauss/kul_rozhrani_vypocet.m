function kul_rozhrani_vypocet;
global jazyk R1 W1 q1 scrsz a1 b1 k;

handle=findobj('Tag','ohnisko');
R=str2num(get(handle,'String'));

handle=findobj('Tag','delkaza');
z0=str2num(get(handle,'String'));

handle=findobj('Tag','index1');
n1=str2num(get(handle,'String'));

handle=findobj('Tag','index2');
n2=str2num(get(handle,'String'));
...
load kul_rozhrani_vypocet
texty=[{'Kulové rozhraní','Parametry svazku pred optickım prvkem','Polomìr svazku W1 je','Polomìr vlnoplochy R1 je','Parametry svazku za optickım prvkem','Znovu','Konec'};
{'Ball boundary','Parameters in front of optical element','Radius of beam W1 is','Radius of waveplane R1 is','Parameters behind optical element','Again','End'}];
